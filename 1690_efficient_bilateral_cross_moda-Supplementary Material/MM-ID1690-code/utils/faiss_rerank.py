...
def rerank_jaccard(centers_RGB, centers_IR, k1=40, k2=6, use_float16=False):

    num_RGB = centers_RGB.shape[0]
    num_IR = centers_IR.shape[0]
    centers = torch.cat((centers_IR, centers_RGB), dim=0)
    jaccard_dist = compute_jaccard_distance(centers, k1=k1, k2=k2, print_flag=True, search_option=3, use_float16=False)
    jaccard_dist_IR_RGB = jaccard_dist[:num_IR, num_IR:]
    return jaccard_dist_IR_RGB